...
categories: music
tags: [music, history, film music, silent Films, huxley, chaplin]
comment: true
...
<!--
Make a quick video with these clips.
How long can it be when it's an educational video?
-->
...
**Chinatown** (1974) by Roman Polanski, music Jerry Goldsmith

* In this score the pianos were many times prepared (something was on the string to change the sound), detuned or sometimes the player played the instrument inside the piano (not hitting the keys). These unusual techniques created dark, mysterious textures (Davis, 2010). Interview with the composer [here](https://www.youtube.com/watch?v=utgHa-b6CO0) `>`.
